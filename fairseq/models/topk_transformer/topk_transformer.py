...
@register_model("topk_transformer")
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            metavar="D",
            default=8,
            help="retain encoder topk self attention",
        )
        parser.add_argument(
            "--decoder-topk",
            type=int,
            metavar="D",
            default=8,
            help="retain decoder topk self attention",
        )
        parser.add_argument(
            "--encoder-decoder-topk",
            type=int,
            metavar="D",
            default=8,
            help="retain encoder decoder topk attention",
        )
