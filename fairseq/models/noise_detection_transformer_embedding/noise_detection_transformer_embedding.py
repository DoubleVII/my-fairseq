...
@register_model("noise_detection_transformer_embedding")
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features_scriptable(
        ...
        batch_size = x.size(1)
        x = torch.cat((self.cls_embedding.expand(-1,batch_size,-1), x), dim=0)
