...
# TEXT=~/data/iwslt14.tokenized.de-en_len
# fairseq-preprocess --source-lang de --target-lang en \
#     --trainpref $TEXT/train --validpref $TEXT/test_long --testpref $TEXT/test_short \
#     --destdir ~/data/data-bin/iwslt14.tokenized.de-en_len_joined \
#     --workers 20 \
#     --joined-dictionary
...
fairseq-train \
   E:/code/data/nmt/data-bin/iwslt14.tokenized.de-en \
   --arch dlcl_rec_transformer_arch --share-decoder-input-output-embed \
   --optimizer adam --adam-betas '(0.9, 0.98)' --clip-norm 0.0 \
   --lr 5e-4 --lr-scheduler inverse_sqrt --warmup-updates 4000 \
   --dropout 0.3 --weight-decay 0.0001 \
   --criterion label_smoothed_cross_entropy --label-smoothing 0.1 \
   ...
   --encoder-recurrent 3 \
   --decoder-recurrent 3 \
   --layer-aggregation linear \
   --encoder-layer-route all \
   --decoder-layer-route all  \
