...
class LayerAttnTransformerDecoderLayer(nn.Module):
    """Decoder layer block.
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(self, args):
        ...
        self.layer_aggregation = self.build_layer_attention(self.embed_dim, args)
    ...
    def build_layer_attention(self, embed_dim, args):
        if args.time_wise_layer_attn:
            return TimeWiseLayerAttention(
                ...
                dropout=args.combination_dropout,
            )
        else:
    ...
    def forward(
        ...
        attn_encoder_out, _ = self.layer_aggregation(
            query=x,
            key=encoder_states,
...
class LinearTransformerDecoderLayer(nn.Module):
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(self, args):
        ...
        self.layer_aggregation = self.build_layer_linear(args)
    ...
    def build_layer_linear(self, args):
        return LayerLinearAggregation(
            args.layer_attention_num, dropout=args.combination_dropout
        )
    ...
    def forward(
        ...
        attn_encoder_out = self.layer_aggregation(encoder_states)
