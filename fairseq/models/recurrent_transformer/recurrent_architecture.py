...
@register_model_architecture("recurrent_transformer", "recurrent_transformer_arch")
def recurrent_transformer_arch(args):
    ...
    args.combination_dropout = getattr(args, "combination_dropout", 0.0)
    ...
    args.layer_aggregation_shared = getattr(args, "layer_aggregation_shared", False)
    args.layer_attention_num = 1 + args.encoder_layers * (
