...
class RobertaHubInterface(nn.Module):
    ...
    def extract_features(
        ...
        features, extra, compositions = self.model(
        ...
        if return_all_hiddens:
            ...
            return features, compositions, extra  # just the last layer's features
    ...
    def predict(
        ...
        features, compositions, extra = self.extract_features(
            tokens.to(device=self.device),
            return_compositions=return_compositions,
            dropout_tokens=dropout_tokens,
        )

        logits, compositions = self.model.classification_heads[head](
            features, compositions
        )
        if return_logits:
            # return logits
            return logits, compositions, extra
