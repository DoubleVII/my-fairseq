...
from .transformer_layer_return_connection import (
...
@register_model("attribution_return_connection_transformer")
    ...
    def forward(
        ...
        for layer in self.layers:
            ...
            if connection_compositions is not None:
                connection_compositions = torch.norm(
                    connection_compositions, dim=-1, p=2
                )
