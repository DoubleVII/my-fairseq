...
@register_model("window_transformer")
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--window-size', type=int, metavar='N',
                            help='half attention window size')
        # fmt: on
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features_scriptable(
        ...
        if incremental_state is not None:
            query_index = prev_output_tokens.size(1) - 1
        ...
        for idx, layer in enumerate(self.layers):
            ...
            x, layer_attn, _ = layer(
                ...
                query_index=query_index if query_index else None,
            )
