...
# print(l)
# index_mat = torch.LongTensor([0, 1, 0, 1]).bool()
# window_size = 3
# window_mask = torch.abs(torch.ones((10, 10)).triu(-window_size).tril(window_size) - 1)
# print(window_mask.bool())
...
window_size = 0
m = torch.abs(torch.ones((10, 10)).triu(-window_size).tril(window_size).unsqueeze(0) - 1)
print(m)