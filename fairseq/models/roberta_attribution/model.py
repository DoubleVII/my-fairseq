...
@register_model("roberta_attribution")
...
class RobertaEncoder(FairseqEncoder):
    ...
    def extract_features(
        ...
        **kwargs,
        ...
        attn_states = encoder_out["attn_states"] if need_attn else None
        return (
            features,
            {"inner_states": inner_states, "attn_states": attn_states},
            compositions,
        )
...
@register_model_architecture("roberta_attribution", "roberta_attribution")
...
@register_model_architecture("roberta_attribution", "roberta_prenorm_attribution")
...
@register_model_architecture("roberta_attribution", "roberta_base_attribution")
def roberta_base_architecture(args):
    base_architecture(args)


@register_model_architecture("roberta_attribution", "roberta_large_attribution")
...
@register_model_architecture("roberta_attribution", "xlm_attribution")
