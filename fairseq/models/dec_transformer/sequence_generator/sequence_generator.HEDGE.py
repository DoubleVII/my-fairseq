...
class SequenceGenerator(nn.Module):
    ...
    def HEDGE(
        ...
        for i in range(tgt_len):
            for j in range(src_len):
                dropout_tokens = list(range(src_len))
                dropout_tokens.remove(j)
                dropout_tokens = torch.LongTensor([dropout_tokens]).to(src_tokens)
    ...
    def _generate(
        ...
        attribution_positional_scores = self.HEDGE(
            net_input,
