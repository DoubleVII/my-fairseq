...
class SequenceGenerator(nn.Module):
    def __init__(
        ...
        pydec.set_decomposition_args(threshold=0.15)

        self.drop_probs = []

        self.dropout_type = "padding"

        logger.info(f"using bias decomposition func {pydec.get_decomposition_name()}")
    ...
    def _generate(
        ...
        net_input = sample["net_input"]
        self.compute_scores(
            composition_positional_scores._composition_tensor.T,
            net_input,
