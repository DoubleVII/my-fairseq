...
@register_model("dec_transformer")
...
@register_model_architecture("dec_transformer", "dec_transformer_tiny")
...
@register_model_architecture("dec_transformer", "dec_transformer")
...
@register_model_architecture("dec_transformer", "dec_transformer_iwslt_de_en")
...
@register_model_architecture("dec_transformer", "dec_transformer_wmt_en_de")
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("dec_transformer", "dec_transformer_vaswani_wmt_en_de_big")
...
@register_model_architecture("dec_transformer", "dec_transformer_vaswani_wmt_en_fr_big")
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, "dropout", 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture("dec_transformer", "dec_transformer_wmt_en_de_big")
...
@register_model_architecture("dec_transformer", "dec_transformer_wmt_en_de_big_t2t")
