    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def forward(
        ...
        Returns:
            encoded output of shape `(seq_len, batch, embed_dim)`
        """
        if manipulate_idx is not None:
            pos_idx = manipulate_idx[0]
            neg_idx = manipulate_idx[1]
        ...
        if self.onnx_trace and incremental_state is not None:
            ...
            return x, attn, self_attn_state, relu_activation
        return x, attn, None, relu_activation
