...
from .fitting_gelu import FittingGelu


logger = logging.getLogger(__name__)


@register_model("roberta_fitting_gelu")
...
class RobertaClassificationHead(nn.Module):
    ...
    def __init__(
        ...
        # self.activation_fn = FittingGelu()
        self.activation_fn = utils.get_activation_fn(activation_fn)
...
@register_model_architecture("roberta_fitting_gelu", "roberta_fitting_gelu")
...
@register_model_architecture("roberta_fitting_gelu", "roberta_prenorm_fitting_gelu")
...
@register_model_architecture("roberta_fitting_gelu", "roberta_base_fitting_gelu")
def roberta_base_architecture(args):
    base_architecture(args)


@register_model_architecture("roberta_fitting_gelu", "roberta_large_fitting_gelu")
...
@register_model_architecture("roberta_fitting_gelu", "xlm_fitting_gelu")
