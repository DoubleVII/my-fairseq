...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features_scriptable(
        ...
        for idx, layer in enumerate(self.layers):
            ...
            layer_attn_holder.append(layer_attn.transpose(1, 0).float().to(x))
        ...
        layer_attn_holder = torch.stack(layer_attn_holder, dim=1) # bsz x layer x head x tgt_len x src_len

        return x, {"attn": [layer_attn_holder], "inner_states": inner_states}
