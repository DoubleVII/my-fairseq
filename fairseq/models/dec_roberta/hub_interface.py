...
class RobertaHubInterface(nn.Module):
    ...
    def extract_features(
        ...
        features, extra, composition = self.model(
        ...
        if return_all_hiddens:
            ...
            return features, composition  # just the last layer's features
    ...
    def predict(
        ...
        features, composition = self.extract_features(
            tokens.to(device=self.device),
            return_composition=return_composition,
            dropout_tokens=dropout_tokens,
        )

        logits, composition = self.model.classification_heads[head](
            features, composition
        )
        if return_logits:
            # return logits
            return logits, composition
