...
@register_model("constrainted_dropout_transformer")
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            type=int,
            metavar="D",
            help="sample num for constrainted dropout",
        )
...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        self.dropout_module = ConstraitedDropout(
            args.dropout, args.dropout_sample_num, embed_tokens.embedding_dim
        )
