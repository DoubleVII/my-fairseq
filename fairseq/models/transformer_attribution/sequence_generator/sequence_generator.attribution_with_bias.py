...
class SequenceGenerator(nn.Module):
    def __init__(
        ...
        logger.info(
            f"using bias decomposition func {CompositionModual.bias_decomposition_name}"
        )
    ...
    def _generate(
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            lprobs, avg_attn_scores, compositions_logits = self.model.forward_decoder(
                tokens[:, : step + 1],
                encoder_outs,
                incremental_states,
                self.temperature,
        ...
        #     assert False
        #     # torch.save(
        #     #     self.decomposition_positional_scores,
        #     #     "/data1/yangs/code/fairseq_models/iwslt14_IRS_UU_near/decomposition_positional_scores.pt",
        #     # )
