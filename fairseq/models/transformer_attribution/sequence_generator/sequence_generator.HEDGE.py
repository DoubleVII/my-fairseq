...
class SequenceGenerator(nn.Module):
    ...
    def HEDGE(
        self, net_input, pred_tokens: LongTensor, positional_scores: Tensor,
    ):
    ...
    def _generate(
        ...
        attribution_positional_scores = self.HEDGE(
            net_input, finalized[0][0]["tokens"], finalized[0][0]["positional_scores"],
        )
        self.compute_scores(
    ...
    def forward_decoder(
        ...
        for i, model in enumerate(self.models):
            ...
            if self.has_incremental_states():
                ...
                decoder_out = model.decoder.forward(
                    tokens, encoder_out=encoder_out, dropout_tokens=dropout_tokens,
                )
