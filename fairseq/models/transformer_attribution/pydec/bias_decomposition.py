...
from pydec.variable_functions import _from_replce
...
def forward_abs_decomposition_(
    c: Composition,
    bias: Union[Number, Tensor] = None,
    *,
    eps=1e-6,
):
    return forward_abs_decomposition(c, bias, eps=eps, inplace=True)
