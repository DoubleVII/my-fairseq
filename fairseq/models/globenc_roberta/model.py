...
@register_model("globenc_roberta")
...
class RobertaEncoder(FairseqEncoder):
    ...
    def extract_features(
        ...
        **kwargs,
        ...
        globenc_attributions = encoder_out["globenc_attributions"]
        return features, {
...
@register_model_architecture("globenc_roberta", "globenc_roberta")
...
@register_model_architecture("globenc_roberta", "globenc_roberta_prenorm")
...
@register_model_architecture("globenc_roberta", "globenc_roberta_base")
def roberta_base_architecture(args):
    base_architecture(args)


@register_model_architecture("globenc_roberta", "globenc_roberta_large")
...
@register_model_architecture("globenc_roberta", "globenc_xlm")
